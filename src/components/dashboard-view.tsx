...
import { buildDemoDashboardData } from "@/lib/dashboard-data";
            ...
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col gap-6">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="glass-card bg-surface-container-low p-5 flex flex-col justify-between h-32 relative overflow-hidden">
                    <div className="z-10">
                    ...
                    <span
                      className="material-symbols-outlined absolute right-[-10px] bottom-[-10px] text-[72px] text-tertiary/8 rotate-12"
                  ...
                  <div className="glass-card bg-surface-container-low p-5 flex flex-col justify-between h-32 relative overflow-hidden">
                    ...
                    <span
                      className="material-symbols-outlined absolute right-[-10px] bottom-[-10px] text-[72px] text-secondary/8 -rotate-12"
                      style={{ userSelect: "none" }}
                    >
                      trending_down
                    </span>
                  ...
                  <div className="glass-card bg-surface-container-low p-5 flex flex-col justify-center h-32">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <span className={`w-2 h-2 rounded-full ${isBalanced ? "bg-green-600" : "bg-red-600"}`} />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col justify-center">
                          ...
                          <div className="flex h-8 rounded-lg overflow-hidden shadow-inner mb-3">
                            ...
                            <div
                              className="bg-secondary h-full flex items-center justify-center text-xs text-white font-medium"
                              style={{ width: "41%" }}
                            ...
                            <div
                              className="bg-surface-container-high h-full flex items-center justify-center text-xs text-on-surface-variant font-medium"
                              style={{ width: "6%" }}
                      ...
                      <div className="flex-1 w-full bg-surface-container rounded-lg border border-outline-variant/30 flex items-center justify-center relative">
                        <div className="flex w-full justify-between px-8 z-10">
                          <div className="space-y-4 w-1/3">
                            <div className="bg-secondary-container text-on-secondary-container text-xs font-bold p-2 rounded text-center border border-outline-variant/40">
                              ICMS (Estadual)
                            </div>
                            <div className="bg-secondary-container text-on-secondary-container text-xs font-bold p-2 rounded text-center border border-outline-variant/40">
                              ISS (Municipal)
                  ...
                  <div className="lg:col-span-4 flex flex-col gap-6">
                    ...
                    <section className="glass-card p-5 border-t-4 border-t-error">
                      ...
                      <ul className="space-y-3 p-0 list-none">
                        ...
                        <li className="bg-secondary-container text-on-secondary-container p-3 rounded-md text-sm border border-outline-variant/40 flex flex-col">
                          <span className="font-bold text-secondary font-headline">Concentração de Receitas</span>
                          <span className="text-xs opacity-80 mt-1">
